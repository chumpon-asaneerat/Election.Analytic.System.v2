...
{
    /// <summary>
    /// Interaction logic for MPD2562PollingUnitManagePage.xaml
    /// </summary>
    public partial class MPD2562PollingUnitManagePage : UserControl
    {
        #region Constructor
        ...
        /// Constructor.
        /// </summary>
        public MPD2562PollingUnitManagePage()
        {
            InitializeComponent();
        }
        ...
        private void Import()
        {
            var win = PPRPApp.Windows.ImportMPD2562PollingUnit;
            win.Setup();
