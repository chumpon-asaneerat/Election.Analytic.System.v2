...
{
    /// <summary>
    /// Interaction logic for ImportMPDC2566OfficialWindow.xaml
    /// </summary>
    public partial class ImportMPDC2566OfficialWindow : Window
    {
        #region Constructor
        ...
        /// Constructor.
        /// </summary>
        public ImportMPDC2566OfficialWindow()
        {
            InitializeComponent();
        }
        ...
        private void Model_SheetItemChanges(object sender, ExcelWorksheetArgs evt)
        {
            ...
            {
                var sheet = evt.Sheet;
                lvMapPreview.Setup<MPDCOfficialImport>(sheet);
            }
        }
        ...
        private void ChooseExcelFile()
        {
            if (model.Open())
            {
                wsMap.Setup<MPDCOfficialImport>(model);
            }
        ...
        private bool Imports()
        {
            ...
            {
                var obj = item as MPDCOfficialImport;
                if (null != obj)
                {
                    obj.ThaiYear = year;
                    obj.RevoteNo = 0;
                    var ret = MPDCOfficialImport.Import(obj);
                    if (ret.HasError)
                    {
                        // get debug string.
