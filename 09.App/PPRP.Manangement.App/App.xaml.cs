        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            EnvironmentOptions option = new EnvironmentOptions()
            {
                ...
                AppInfo = new NAppInformation()
                {
                    ...
                    Version = AppConsts.Application.Management.Version,
                    Minor = AppConsts.Application.Management.Minor,
                    Build = AppConsts.Application.Management.Build,
                    LastUpdate = AppConsts.Application.Management.LastUpdate
                },
                /* Setup Storage */
