        ...
        protected override void OnStartup(StartupEventArgs e)
        {
            ...
            EnvironmentOptions option = new EnvironmentOptions()
            {
                ...
                AppInfo = new NAppInformation()
                {
                    ...
                    CompanyName = "PPRP",
                    /*  This property is required */
                    ProductName = AppConsts.Application.Analytic.ApplicationName,
                    /* For Application Version */
                    Version = AppConsts.Application.Analytic.Version,
                    Minor = AppConsts.Application.Analytic.Minor,
                    Build = AppConsts.Application.Analytic.Build,
                    LastUpdate = AppConsts.Application.Analytic.LastUpdate
                },
                /* Setup Storage */
